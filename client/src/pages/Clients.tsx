...
export default function Clients() {
  ...
  const getStatusColor = (status: Client['status']) => {
    switch (status) {
      ...
      case "Waiting on Client": return "bg-yellow-100 text-yellow-700";
            ...
            <div className="flex justify-between items-start">
              <div className="flex-1">
                <div className="flex items-center space-x-2">
                  <h3 className="font-semibold text-lg text-gray-900">{client.businessName}</h3>
                ...
                <div className="flex items-center mt-3 text-xs text-muted-foreground space-x-4">
                  ...
                  {client.deliveryDate && (
                     <span className="flex items-center">
                      ...
                      Due: {format(new Date(client.deliveryDate), "MMM d, yyyy")}
                    </span>
                  )}
                </div>
              </div>
